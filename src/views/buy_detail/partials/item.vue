<template>
  <Carousel v-bind="settings" :breakpoints>
    <Slide v-for="(n, i) in 3" :key="n">
      <v-hover v-slot:default="{ isHovering, props }">
        <v-responsive class="rounded pa-sm-2 align-start">
          <v-container class="rounded bg-white">
            <v-img
              src="https://demo03.houzez.co/wp-content/uploads/2016/03/040-1170x877.jpg"
              cover
              aspect-ratio="1.3"
              style="height: 100%"
            >
            ...
            <div class="d-flex flex-column justify-center ga-2 mt-2">
              <div class="mt-4">
                <div class="font-weight-bold text-h6">Studio, One Bedroom</div>
              </div>
              <div class="mt-2">
                <div class="">From $876.000</div>
                <div class="text-caption font-weight-light mt-2">TYPE 1</div>
              </div>
